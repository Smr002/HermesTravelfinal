            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Destination Management Company in Balkans and doing this for more than 4 years now</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <p class="text-muted">We have very competitive prices thanks to our long time investment in systemsand our contracting team</p>
                    </div>
                </div>
            </div>
        </section>
